...
BENCHMARK_REGISTER_F(MicroBenchmarkFixture, SCALABILITY_INSERT_ ## NAME)->Unit(benchmark::kMillisecond)->INSERT_ITERATIONS_AND_REPETITIONS->UseRealTime()->Args({(SZ_TAXI_XL_INITIAL_POINTS_AMONT), ((SZ_TAXI_XL_ADDED_POINTS_AMONT)), 24});\
BENCHMARK_REGISTER_F(MicroBenchmarkFixture, SCALABILITY_INSERT_ ## NAME)->Unit(benchmark::kMillisecond)->INSERT_ITERATIONS_AND_REPETITIONS->UseRealTime()->Args({(SZ_TAXI_XL_INITIAL_POINTS_AMONT), ((SZ_TAXI_XL_ADDED_POINTS_AMONT)), 32});\
BENCHMARK_REGISTER_F(MicroBenchmarkFixture, SCALABILITY_INSERT_ ## NAME)->Unit(benchmark::kMillisecond)->INSERT_ITERATIONS_AND_REPETITIONS->UseRealTime()->Args({(SZ_TAXI_XL_INITIAL_POINTS_AMONT), ((SZ_TAXI_XL_ADDED_POINTS_AMONT)), 36});
...
BENCHMARK_REGISTER_F(MicroBenchmarkFixture, NAME)->Unit(benchmark::kMillisecond)->QUERY_ITERATIONS_AND_REPETITIONS->UseRealTime()->Args({SZ_TAXI_XL_INITIAL_POINTS_AMONT+SZ_TAXI_XL_ADDED_POINTS_AMONT,BATCH_SIZE,24});\
BENCHMARK_REGISTER_F(MicroBenchmarkFixture, NAME)->Unit(benchmark::kMillisecond)->QUERY_ITERATIONS_AND_REPETITIONS->UseRealTime()->Args({SZ_TAXI_XL_INITIAL_POINTS_AMONT+SZ_TAXI_XL_ADDED_POINTS_AMONT,BATCH_SIZE,32});\
BENCHMARK_REGISTER_F(MicroBenchmarkFixture, NAME)->Unit(benchmark::kMillisecond)->QUERY_ITERATIONS_AND_REPETITIONS->UseRealTime()->Args({SZ_TAXI_XL_INITIAL_POINTS_AMONT+SZ_TAXI_XL_ADDED_POINTS_AMONT,BATCH_SIZE,36});
